	...
	<div id="content">
		...
		<form:form modelAttribute="produit" action="produit/${produit.id}" method="post">
			...
			<table>
				<tr>
					<td>Libelle :</td>
					<td><form:input required="required" path="libelle" placeholder="Saisir votre libelle"/><form:errors class="errorForm"  path="libelle"/></td></tr></td>
				</tr>
				<tr>
					<td>Prix :</td>
					<td><form:input required="required" path="prix" type="number" placeholder="Saisir prix" step="0.01"/><form:errors class="errorForm"  path="prix"/></td>
				</tr>
				<tr>
					<td>Fournisseur :</td>
					<td>
